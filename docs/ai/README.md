...
This section defines governance for ScrapTrace computer vision, approved safety content, controlled Large Language Model (LLM) use, evaluation, data labels, and responsible AI. It documents requirements only: no model, prompt, provider call, safety card, or evaluation artefact exists yet.
